...
keyauthapp = api(
    name = "boosta botr",
    ownerid = "AOLuMHwyWA",
    secret = "cfd121b1da179a31fca371565aa7c27923ba7891cd3be9e56c1f4f77e52e6e80",
    version = "1.0",
...
async def givetokens(ctx, type: discord.Option(int, "Type of tokens to give, 1 month or 3 months.", required = True), amount: discord.Option(int, "Amount of tokens to give.") = 0):
    if ctx.author.id not in config["ownerID"]:
